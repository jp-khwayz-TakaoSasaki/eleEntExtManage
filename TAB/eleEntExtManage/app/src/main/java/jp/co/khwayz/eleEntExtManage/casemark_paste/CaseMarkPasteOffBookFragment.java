...
import jp.co.khwayz.eleEntExtManage.databinding.FragmentCaseMarkPasteOffBookBinding;
import jp.co.khwayz.eleEntExtManage.dialog_fragment.MessageDialogFragment;
import jp.co.khwayz.eleEntExtManage.packing.PackingScanOffBookRecyclerViewAdapter;
import jp.co.khwayz.eleEntExtManage.util.Util;

public class CaseMarkPasteOffBookFragment extends BaseFragment implements RFIDDataDelegate, BarcodeDataDelegate {
    // DataBinding
    FragmentCaseMarkPasteOffBookBinding mBinding;
    // Adapter
    ...
    public static CaseMarkPasteOffBookFragment newInstance(String invoiceNo) {
        CaseMarkPasteOffBookFragment fragment = new CaseMarkPasteOffBookFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBinding = FragmentCaseMarkPasteOffBookBinding.inflate(inflater, container, false);
    ...
    public void viewSetting() {
        ...
        // タイトル
        mListener.setSubTitleText(getString(R.string.casemark_paste) + getString(R.string.casemark_offbook));
        mListener.setScreenId(getString(R.string.screen_id_casemark_paste_offbook));

        // サブヘッダセット
        mBinding.offBookConfirmViewInvoiceNo.setText(this.mInvoiceNo);
        mBinding.offBookConfirmViewReadCount.setText(String.valueOf(Application.scanOffBooklList.size()));
