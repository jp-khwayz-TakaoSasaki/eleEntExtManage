 ...
 * 品目備考更新Task
 */
public class PostItemRemarksTask extends HttpTaskBase<SimpleResponse> {
    // region [ private variable ]
    public static final String TAG = PostItemRemarksTask.class.getSimpleName();
    private final String mURL;
    private final String mJsonParam;
    // endregion

    // region [ constructor ]
    public PostItemRemarksTask(@NonNull Callback<SimpleResponse> callback, String url, String paramJson) {
        super(callback);
        mURL = url;
