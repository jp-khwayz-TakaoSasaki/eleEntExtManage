...
import jp.co.khwayz.eleEntExtManage.http.request.CombineRegistrationRequest;
 ...
 * 同梱更新Task
 */
public class PostCombineRegistrationTask extends HttpTaskBase<SimpleResponse> {
    // region [ private variable ]
    private final String mURL;
    private final CombineRegistrationRequest mRequestParam;
    private final ArrayList<TagInfo> mParamList;
    // endregion

    // region [ constructor ]
    public PostCombineRegistrationTask(@NonNull Callback<SimpleResponse> callback, String url,
                                       CombineRegistrationRequest requestParam, ArrayList<TagInfo> paramList) {
        super(callback);
        mURL = url;
    ...
    protected SimpleResponse doInBackground() {
        ...
        try {
            ...
            for (TagInfo tag : mParamList) {
                CombineRegistrationRequest.RequestDetail req = new CombineRegistrationRequest.RequestDetail();
                // 発注番号
