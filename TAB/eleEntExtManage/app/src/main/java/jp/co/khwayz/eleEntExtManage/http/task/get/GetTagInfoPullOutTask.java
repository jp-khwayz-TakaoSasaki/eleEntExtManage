...
public class GetTagInfoPullOutTask extends HttpTaskBase<TagInfoResponse> {
    ...
    // region [ constructor ]
    public GetTagInfoPullOutTask(@NonNull Callback<TagInfoResponse> callback, String url, String jsonParam) {
        super(callback);
        mURL = url;
