...
namespace Elematec.EntExtManage_RFIDSystem_Importer.AppSettings
{
    public class AppSettings
    {
        ...
        public class Import
        {
            ...
            /// </summary>
            public static string WarehousingBaseName { get; set; }

            /// <summary>
            /// 無償品ファイル名※拡張子なし
            /// </summary>
            public static string FreeProductBaseName { get; set; }
            ...
            /// 受信監視の間隔　※ミリ秒
            /// </summary>
            public static int ReceiveInterval { get; set; }

            public static void ReadElement(XmlReader xr)
            {
                if (xr.Name == "FilePreserveDay") { FilePreserveDay = Convert.ToInt32(xr.ReadString().Trim()); }
                else if (xr.Name == "SuccessedFolderPath") { SuccessedFolderPath = xr.ReadString().Trim(); }
                else if (xr.Name == "WarehousingBaseName") { WarehousingBaseName = xr.ReadString().Trim(); }
                else if (xr.Name == "FreeProductBaseName") { FreeProductBaseName = xr.ReadString().Trim(); }
                else if (xr.Name == "FailedFolderPath") { FailedFolderPath = xr.ReadString().Trim(); }
                ...
                else if (xr.Name == "ReceiveInterval") { ReceiveInterval = Convert.ToInt32(xr.ReadString().Trim()); }
                else { }
            }
            ...
            public static void Save(XmlDocument xmlDoc)
            {
                ...
                nodelist = xmlDoc.SelectNodes(targetNode + "WarehousingBaseName");
                if (nodelist.Count > 0)
                {
                    newNode = nodelist.Item(0);
                    newNode.InnerText = WarehousingBaseName.ToString();
                    nodelist.Item(0).ParentNode.ReplaceChild(newNode, nodelist.Item(0));
                }

                nodelist = xmlDoc.SelectNodes(targetNode + "FreeProductBaseName");
                if (nodelist.Count > 0)
                {
                    newNode = nodelist.Item(0);
                    newNode.InnerText = FreeProductBaseName.ToString();
                    nodelist.Item(0).ParentNode.ReplaceChild(newNode, nodelist.Item(0));
                }
                ...
                {
                    newNode = nodelist.Item(0);
                    newNode.InnerText = ReceiveFolderPath.ToString();
                    nodelist.Item(0).ParentNode.ReplaceChild(newNode, nodelist.Item(0));
                }
                ...
                {
                    newNode = nodelist.Item(0);
                    newNode.InnerText = CheckFileExtension.ToString();
                    nodelist.Item(0).ParentNode.ReplaceChild(newNode, nodelist.Item(0));
                }
                ...
                {
                    newNode = nodelist.Item(0);
                    newNode.InnerText = ImportFileExtension.ToString();
                    nodelist.Item(0).ParentNode.ReplaceChild(newNode, nodelist.Item(0));
                }

                nodelist = xmlDoc.SelectNodes(targetNode + "ReceiveInterval");
                if (nodelist.Count > 0)
                {
                    newNode = nodelist.Item(0);
                    newNode.InnerText = ReceiveInterval.ToString();
                    nodelist.Item(0).ParentNode.ReplaceChild(newNode, nodelist.Item(0));
                }
            }
        }
        ...
        public static void SaveXmlFile()
        {
            ...
            SaveXmlFile(GetCurrentDirectory() + "\\AppSettings\\" + "AppSettings.xml");
        }
